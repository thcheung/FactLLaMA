...
def train(
    ...
    train_path: str = "cleaned2/liarraw/train.json",
    test_path: str = "cleaned2/liarraw/test.json",
    output_dir: str = "./lora-alpaca-liarraw2",
    ...
    resume_from_checkpoint: str = "alpaca-7b-lora",  # either training checkpoint or final adapter
    ...
    if train_path.endswith(".json") or train_path.endswith(".jsonl"):
        ...
        data = load_dataset(data_files={"train": train_path,"test": test_path})
